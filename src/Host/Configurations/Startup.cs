namespace Microsoft.Teams.Assist.Host.Microsoft.Teams.Assist.Host.Configurations
{
    internal static class Startup
    {
        internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
        {
            ...
            builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                    ...
                    .AddJsonFile($"{configurationsDirectory}/frontuserportal.json", optional: false, reloadOnChange: true)
                    .AddJsonFile($"{configurationsDirectory}/frontuserportal.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
