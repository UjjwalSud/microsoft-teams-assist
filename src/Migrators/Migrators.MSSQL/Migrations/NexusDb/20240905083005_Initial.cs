        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FKNexusLookUpCodePKId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LookUpCodeValues_LookUpCodes_FKNexusLookUpCodePKId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    FKSubscriptionPKId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FKLastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tenants_Subscriptions_FKSubscriptionPKId",
                        column: x => x.FKSubscriptionPKId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserFriendlyRoleName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FKTenantPKId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LookUpCodeValues_FKNexusLookUpCodePKId",
                schema: "dbo",
                table: "LookUpCodeValues",
                column: "FKNexusLookUpCodePKId");

            migrationBuilder.CreateIndex(
                name: "IX_Tenants_FKSubscriptionPKId",
                schema: "dbo",
                table: "Tenants",
                column: "FKSubscriptionPKId");
        }
